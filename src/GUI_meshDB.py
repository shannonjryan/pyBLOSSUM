...
class PackageLoader(QThread):
    ...
    def run(self):
        ...
        self.packages_loaded.emit({
            ...
            'meshDB_performance': meshDB_performance
        })
    ...
    def on_run_button_clicked(self):
        ...
        try:           
            ...
            data = {
                ...
                'mesh_AD': float(self.meshAD_entry.text()),  # units = g/cm2
                ...
                'kevlar_AD': float(self.kevlarAD_entry.text()),  # units = g/cm3   
            ...
            df_plot['dc_BLE'] = df_plot.apply(self.packages['meshDB_performance'],axis=1)
