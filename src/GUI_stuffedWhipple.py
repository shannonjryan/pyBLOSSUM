...
class PackageLoader(QThread):
    ...
    def run(self):
        ...
        self.packages_loaded.emit({
            ...
            'stuffedWhipple_performance': stuffedWhipple_performance
        })
...
class MyApp(QWidget):
    ...
    def initUI(self):        
        ...
        self.note_label = QLabel("NOTE: The stuffing is assumed to be equidistant \nbetween the bumper and rear wall", self)
    ...
    def on_run_button_clicked(self):
        ...
        try:
            ...
            data = {
                ...
                'kevlar_AD': float(self.kevlarAD_entry.text()),  # units = g/cm2
                'nextel_AD': float(self.nextelAD_entry.text()),   # units = g/cm2          
            ...
            df_plot['dc_BLE'] = df_plot.apply(self.packages['stuffedWhipple_performance'],axis=1)
