...
class MyApp(QWidget):
    ...
    def on_material1_selected(self, index):
        ...
        self.hardness_entry.setText(str(df_materials.loc[df_materials['mat'] == selected_material, 'hardness'].values[0]))
        soundspeed = np.sqrt(df_materials.loc[df_materials['mat'] == selected_material, 'tensile_modulus'].values[0]/df_materials.loc[df_materials['mat'] == selected_material, 'density'].values[0])
        self.soundspeed_entry.setText(f'{soundspeed:.2f}')           
    ...
    def on_run_button_clicked(self):
        ...
        try:
            ...
            data = {
                ...
                'shield_thick': float(self.thickness_entry.text()),
                'shield_density': float(self.density1_entry.text()),                
                'shield_HB': float(self.hardness_entry.text()),
                'shield_C': float(self.soundspeed_entry.text()),
                'MLI_AD': float(self.MLI_entry.text()) if self.MLI_entry.text != "" else 0
            }
